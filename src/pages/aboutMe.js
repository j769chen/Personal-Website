    ...
    <main>
      ...
      <Container>
        <p>
          ...
          the opportunity to co-op at Raven Telemetry, which helped me to
          discover my passion for software development.
        </p>
        <p>
          I have always enjoyed learning, and I love to create. Whenever I can,
          I enjoy experimenting with new technologies and using code to develop
          cool software projects. I am currently working on{" "}
          ...
          displays the current <span>Badminton World Rankings</span> using
          Python &amp; Flask to name a few. Feel free to check out my{" "}
